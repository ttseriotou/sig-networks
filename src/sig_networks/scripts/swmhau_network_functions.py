...
from sig_networks.scripts.swnu_network_functions import obtain_SWNUNetwork_input
from sig_networks.swmhau_network import SWMHAUNetwork
...
def implement_swmhau_network(
    ...
    -------
    tuple[SWMHAUNetwork, pd.DataFrame]
        SWMHAUNetwork object (if k-fold, this is a randomly
...
def swmhau_network_hyperparameter_search(
    ...
    """
    Performs hyperparameter search for the SWMHAUNetwork model
    ...
    SWMHAUNetwork on various seeds and averaging performance over the seeds.
    ...
    will average over the performance of the SWMHAUNetwork
